...
%3 Prioritat:TaskSet Eingeben

NameOfResultFile=input('Input the Name of Result OutputFile to save:','s');
fid_Result=fopen(NameOfResultFile,'w');
simulationtime=input('Input simulationtime(as large as possible):');
NumOfTask=input('Input number of tasks:');
CPU_Bandwidth=input('Input CPU_Bandwidth(1 is default):');
p1min=input('Input p1min:');
p1max=input('Input p1max:');
j1=input('Input j1:');
d1=input('Input d1:');
e1min=input('Input e1min:');
e1max=input('Input e1max:');
ph1max=input('Input phase1 max:');

p2min=input('Input p2min:');
p2max=input('Input p2max:');
j2=input('Input j2:');
d2=input('Input d2:');
e2min=input('Input e2min:');
e2max=input('Input e2max:');
ph2max=input('Input phase2 max:');

p3min=input('Input p3min:');
p3max=input('Input p3max:');
j3=input('Input j3:');
d3=input('Input d3:');
e3min=input('Input e3min:');
e3max=input('Input e3max:');
ph3max=0;
    ...
    for p2=p2min:p2max
        for p3=p3min:p3max
            for e1=e1min:e1max
                for e2=e2min:e2max
                    for e3=e3min:e3max
                        FileName=sprintf('FP_P1_%d_P2_%d_P3_%d_e1_%d_e2_%d_e3_%d',p1,p2,p3,e1,e2,e3);
