...
CPU_Bandwidth=1;
simulationtime=40000;%Einheit:ms
NumOfTask=60;
...
set_param('MasterArbeit_EreignisgeneratorsOhneTotzone','StartTime','0','StopTime','40');
...
for k=1:NumOfSimulation
    ...
    set_param('MasterArbeit_Ereignisgenerators','StartTime','0','StopTime','40');
...
% 
% MasterArbeit_EreignisgeneratorsNachInterrupt
% set_param('MasterArbeit_EreignisgeneratorsNachInterrupt','StartTime','0','StopTime','40');
% set_param('MasterArbeit_EreignisgeneratorsNachInterrupt','Solver','ode45')
