...
CPU_Bandwidth=1;
simulationtime=20000;%Einheit:ms
NumOfTask=80;
sollwert=10;
NumOfSimulation=100;
...
MasterArbeit_EreignisgeneratorsNachISS
set_param('MasterArbeit_EreignisgeneratorsNachISS','StartTime','0','StopTime','20');
set_param('MasterArbeit_EreignisgeneratorsNachISS','Solver','ode45')
...
for i=1:NumOfSimulation
    ...
    set_param('MasterArbeit_EreignisgeneratorsNachISS','StartTime','0','StopTime','15');
    set_param('MasterArbeit_EreignisgeneratorsNachISS','Solver','ode45')
    set_param('MasterArbeit_EreignisgeneratorsNachISS','stopfcn','Evaluation')
    sim('MasterArbeit_EreignisgeneratorsNachISS')
